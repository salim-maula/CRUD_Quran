...
import com.example.bismilahjadi.Adapter.SurahAdapter
import com.example.bismilahjadi.Adapter.SurahAdapter.onSelectData
import com.example.bismilahjadi.NoteListActivity
import com.example.bismilahjadi.R
import com.example.bismilahjadi.model.ModelSurah
import com.example.bismilahjadi.networking.Api
...
class   ListSurahActivity : AppCompatActivity(), onSelectData, View.OnClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val fabCatatan: FloatingActionButton = findViewById(R.id.fabNote)
        fabCatatan.setOnClickListener(this)
    ...
    override fun onClick(v: View?) {
        when (v?.id) {
            R.id.fabNote -> {
                val catatan = Intent(this@ListSurahActivity, NoteListActivity::class.java)
